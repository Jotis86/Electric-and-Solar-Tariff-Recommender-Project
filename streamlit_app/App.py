...
if seccion_seleccionada == "Inicio":
    ...
    with col2:
        ...
        <div class="card">
            ...
            <p>Disminuye tu huella de carbono utilizando energía solar y optimizando tu consumo.</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col1:
        ...
        <div class="card">
            ...
            <ul>
                <li>Proporciona tu consumo mensual</li>
...
# Sección de Recomendador
    ...
    with col2:
        ...
        <div class="form-section" style="text-align: center;">
            ...
            <p style="color: #333;">en tu factura de luz eligiendo la tarifa correcta para ti</p>
        </div>
        """, unsafe_allow_html=True)
